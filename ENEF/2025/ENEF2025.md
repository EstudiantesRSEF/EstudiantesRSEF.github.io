...
<!-- FOTOS -->
      <div class="scroll-container">
        <img id="desktop-img" class="materialboxed scroll-image" width="100%" src="/img/eventos/2024-ENEF/Galeria/ENEF23GaleriaBig.png">
        <img id="mobile-img" class="materialboxed scroll-image" width="100%" src="/img/eventos/2024-ENEF/Galeria/ENEF23GaleriaSmall.png">
      </div>
      <div class="row center">
      ...
      <div class="row center">
        <span id="event-label" class="event-label">ENEF Oviedo 2023</span>
      </div>
<!-- OBJETIVOS -->
