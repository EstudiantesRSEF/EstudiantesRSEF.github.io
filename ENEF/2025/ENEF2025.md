...
<div class="section">
  ...
  <div class="row center" style="margin-top: 2em;">
    <div class="col s12 m4">
      <a href="/ENEF/2025/files/bases_presentaciones.pdf" class="btn-rounded enef25-pink">
        <i class="fa fa-file-powerpoint-o"></i>
        Bases Presentaciones
      </a>
    </div>
    <div class="col s12 m4">
      <a href="/ENEF/2025/files/bases_posters.pdf" class="btn-rounded enef25-pink">
        <i class="fa fa-file-image-o"></i>
        Bases Pósters
      </a>
    </div>
    <div class="col s12 m4">
      <a href="/ENEF/2025/files/bases_fotografia.pdf" class="btn-rounded enef25-pink">
