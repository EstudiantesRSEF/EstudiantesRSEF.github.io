...
<!-- BOTONES -->
    <div class="section">
      <div class="row">
        ...
        <div class="col s6 m6 l3">
          <div class="row center">
            <a href="{{ site.url }}/ENEF2025/programa" id="boton-programa" class="btn-degradado">Programa</a>
          </div>
        </div>
        <div class="col s6 m6 l3">
          <div class="row center">
