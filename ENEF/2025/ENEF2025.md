...
<!-- Desktop Carousel -->
<div id="PrevENEFs-desktop" class="carousel slide content-desktop" data-ride="carousel">
  <ul class="carousel-indicators">
    {% for edition in site.data.ENEF.2025.multiple.enef_preveditions %}
      <li data-target="#PrevENEFs-desktop" data-slide-to="{{ forloop.index0 }}" {% if forloop.first %}class="active"{% endif %}></li>
    {% endfor %}
  </ul>  
  <div class="carousel-inner">
    {% for edition in site.data.ENEF.2025.multiple.enef_preveditions %}
      <div class="carousel-item {% if forloop.first %}active{% endif %}">
        <img src="{{ edition.img_desktop }}" alt="{{ edition.name }}">
  ...
  <a class="carousel-control-prev" href="#PrevENEFs-desktop" data-slide="prev">
    <span class="carousel-control-prev-icon"></span>
  </a>
  <a class="carousel-control-next" href="#PrevENEFs-desktop" data-slide="next">
    <span class="carousel-control-next-icon"></span>
  </a>
</div>

<!-- Mobile Carousel -->
<div id="PrevENEFs-mobile" class="carousel slide content-mobile" data-ride="carousel">
  <ul class="carousel-indicators">
    {% for edition in site.data.ENEF.2025.multiple.enef_preveditions %}
      <li data-target="#PrevENEFs-mobile" data-slide-to="{{ forloop.index0 }}" {% if forloop.first %}class="active"{% endif %}></li>
    {% endfor %}
  </ul>  
  <div class="carousel-inner">
    {% for edition in site.data.ENEF.2025.multiple.enef_preveditions %}
      <div class="carousel-item {% if forloop.first %}active{% endif %}">
        <img src="{{ edition.img_mobile }}" alt="{{ edition.name }}">
        <div class="carousel-caption" style="background-color: {{ edition.color }}99">
          <h3>{{ edition.name }}</h3>
        </div>
      </div>
  ...
  <a class="carousel-control-prev" href="#PrevENEFs-mobile" data-slide="prev">
    <span class="carousel-control-prev-icon"></span>
  </a>
  <a class="carousel-control-next" href="#PrevENEFs-mobile" data-slide="next">
    <span class="carousel-control-next-icon"></span>
  </a>
</div>
<!-- OBJETIVOS -->         
