      ...
      <div class="row">
        <div class="col s6 m6 l3">
          <div class="row center">
            <a href="#objetivos" id="boton-objetivos" class="btn-square enef26-red">Objetivos</a>
          </div>
        </div>
        <div class="col s6 m6 l3">
          <div class="row center">
            <a href="{{ site.url }}/ENEF2026/programa/" id="boton-programa" class="btn-square enef26-red">Programa</a>
          </div>
        </div>
        <div class="col s6 m6 l3">
          <div class="row center">
            <a href="#concursos" id="boton-concursos" class="btn-square enef26-red">Concursos</a>
          </div>
        </div>
        <div class="col s6 m6 l3">
          <div class="row center">
            <a href="#inscribete" id="boton-inscribete" class="btn-square enef26-red">¡Inscríbete!</a> 	      
          </div>
        </div>
      </div>
    </div>
...
<!-- OBJETIVOS -->         
    ...
    <div class="section">
      ...
      <div class="row center">
        <a href="{{ site.url }}/ENEF2026/programa" id="boton-programa" class="btn-rounded enef26-yellow">Conoce el programa provisional</a>
      </div>
    </div>
    <!--
    <div class="section">
...
<div class="section">
  ...
  <div class="row center" style="margin-top: 2em;">
    <div class="col s12 m4">
      <a href="/ENEF/2025/Concursos/ENEF25_BasesPresentaciones.pdf" class="btn-rounded enef26-red">
        <i class="fa fa-file-powerpoint-o"></i>
        Bases Presentaciones
      </a>
    </div>
    <div class="col s12 m4">
      <a href="/ENEF/2025/Concursos/ENEF25_BasesPosters.pdf" class="btn-rounded enef26-red">
        <i class="fa fa-file-image-o"></i>
        Bases Pósters
      </a>
    </div>
    <div class="col s12 m4">
      <a href="/ENEF/2025/Concursos/ENEF25_BasesFotografia.pdf" class="btn-rounded enef26-red">
    ...
    <div class="section">
      ...
      <div class="row">
        <div class="col s12 m12 l12">
          <div class="row center">
            <h2>Paso 1:</h2>
            <a href="{{ site.url }}/inscripcion" target="_blank" class="btn-rounded enef26-red">Inscripción GdeE</a>
        ...
        <div class="col s12 m6 l6">
          <div class="row center">
            <h2>Paso 2:</h2>
            <a href="{{ site.url }}/ENEF2026/inscripcion" target="_blank" class="btn-rounded enef26-red">Inscripción ENEF</a>
          </div>
        </div>
        <div class="col s12 m6 l6">
          <div class="row center">
            <h2>Paso 3:</h2>
            <a href="#modal-pago" class="collection-item modal-trigger btn-rounded enef26-red">Pago</a>
