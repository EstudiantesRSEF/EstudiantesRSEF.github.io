      ...
      <div class="row">
        <div class="col s6 m6 l3">
          <div class="row center">
            <a href="#objetivos" id="boton-objetivos" class="btn-square enef26-blue">Objetivos</a>
          </div>
        </div>
        <div class="col s6 m6 l3">
          <div class="row center">
            <a href="{{ site.url }}/ENEF2026/programa/" id="boton-programa" class="btn-square enef26-blue">Programa</a>
          </div>
        </div>
        <div class="col s6 m6 l3">
          <div class="row center">
            <a href="#concursos" id="boton-concursos" class="btn-square enef26-blue">Concursos</a>
          </div>
        </div>
        <div class="col s6 m6 l3">
          <div class="row center">
            <a href="#inscribete" id="boton-inscribete" class="btn-square enef26-blue">¡Inscríbete!</a> 	      
          </div>
        </div>
      </div>
    </div>
...
<div id="content-desktop">
  <div id="PrevENEFs-desktop" class="carousel carousel-dark slide" data-bs-ride="carousel">
    <div class="carousel-indicators">
      {% for edition in site.data.ENEF.2026.multiple.enef_preveditions %}
        <button type="button" 
...
<!-- OBJETIVOS -->         
    <div class="section">
      ...
      <div class="row center">
        <img class="materialboxed" width="100%" src="/ENEF/2026/img/Objetivos ENEF26 web.png">
      </div>
    </div>
    ...
    <div class="section">
      ...
      <div class="row center">
        <a href="{{ site.url }}/ENEF2026/programa" id="boton-programa" class="btn-rounded enef26-orange">Conoce el programa provisional</a>
      </div>
    </div>
    <!-- Comentar cuando todo esté terminado-->
    <div class="section">
      <p style="text-align: justify;">¡Conoce a los ponentes del ENEF 2026!</p>
      <div class="row center">
        <a href="/ENEF2026/ponentes/" class="btn-rounded enef26-blue">Ver la página de ponentes</a>
      </div>
      <!--
      <p style="text-align: justify;">Además contaremos con: </p>
      <div class="ponente-container">
        {% for person in site.data.ENEF.2026.ponentes %}
...
<div class="section">
  ...
  <div class="row center" style="margin-top: 2em;">
    <div class="col s12 m6">
      <a href="/ENEF/2026/Concursos/Concurso_presentaciones.pdf" class="btn-rounded enef26-blue">
        <i class="fa fa-file-powerpoint-o" style="color: #FFB997;"></i>
        Bases Presentaciones
      </a>
    </div>
    <div class="col s12 m6">
      <a href="/ENEF/2026/Concursos/Concurso de pósters.pdf" class="btn-rounded enef26-blue">
        <i class="fa fa-file-image-o" style="color: #FFB997;"></i>
        Bases Pósters
      </a>
    </div>
  </div>
    ...
    <div class="section">
      ...
      <div class="row">
        ...
        <div class="col s12 m6 l6">
          <div class="row center">
            <h2>Paso 2:</h2>
            <a href="{{ site.url }}/ENEF2026/inscripcion" target="_blank" class="btn-rounded enef26-blue">Inscripción ENEF</a>
          </div>
        </div>
        <div class="col s12 m6 l6">
          <div class="row center">
            <h2>Paso 3:</h2>
            <a href="#modal-pago" class="collection-item modal-trigger btn-rounded enef26-blue">Pago</a>
            <p>Instrucciones enviadas por mail a los participantes</p>
          </div>
        </div>
      </div>
      <p style="text-align: justify;">¡Después de esto solo debes planear tu viaje hasta Valencia y cargar pilas para vernos a finales de julio!</p>
      <p style="text-align: justify;">Si tienes alguna duda puedes acceder a la página de preguntas frecuentes pinchando en el botón o escribirnos a <a href="mailto:estudiantes@rsef.es?subject=[ENEF 2026]" class = "enef25-link">estudiantes@rsef.es</a>.</p>
      <div class="row center">
        <a href="{{ site.url }}/ENEF2026/FAQs" id="boton-faqs" class="btn-rounded enef26-blue">FAQs</a>
      </div>
    </div>      
    <!-- SPONSORS -->
    {% include patrocinadores.html sponsors=site.data.ENEF.2026.patrocinadores %}    
  </div>
</div>
...
{% include Modals/person_modals.html people=site.data.ENEF.2026.ponentes%}
