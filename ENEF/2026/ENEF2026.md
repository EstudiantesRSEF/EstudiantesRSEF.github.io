...
<!-- INSCRIPCIÓN -->
    <div class="section">
      ...
      <p style="text-align: justify;">Si tienes alguna duda, escríbenos a <a href="mailto:estudiantes@rsef.es?subject=[ENEF 2026]" class = "enef25-link">estudiantes@rsef.es</a>.</p>
    </div>      
    <!-- SPONSORS -->
