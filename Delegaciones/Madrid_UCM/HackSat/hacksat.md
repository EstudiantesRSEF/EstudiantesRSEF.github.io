...
<div class="col-md-6">
  <a href="https://maps.app.goo.gl/sFfWaPtD8Htnec616">
...
<div class="fs-5 fw-semibold mb-4">
  ...
  <div class="d-flex flex-wrap justify-content-center align-items-center gap-5 m-4">
          <a href="https://amigosrac.es/" class="sponsor-card">
              <img src="{{ site.baseurl }}/Delegaciones/Madrid_UCM/HackSat/img/rac_logo.jpg" alt="Amigos RAC Logo" class="max-h-24 mw-100 object-fit-contain">
          </a>
  </div>
    <div class="fs-5 fw-semibold mb-4">
    Anfitriones
