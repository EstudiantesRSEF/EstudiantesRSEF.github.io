    ...
    {% for item in site.data.LC %}
        {% unless item.congelado %}
                ...
                <li class="collection-item avatar  waves-effect waves-light" id="{{ item.nombre }}">
                    ...
                    {% endunless %}
                    <img src="{{ item.img }}" alt="" class="circle" style="object-fit: cover; width: 96px; height: 96px;">
  ...
  <div class="modal-content">
    <div class="section" style="padding-left: 30px; padding-right: 30px;">
      <div class="row">
        ...
        <!-- Iconos de contacto en el modal -->
        <div class="row center" style="margin-top: 20px;">
            {% if item.url != nil %}    
                <a href="{{ item.url }}" target="_blank" title="Página Web" style="margin-right: 15px; color: inherit;">
                    <i class="fa fa-2x fa-globe" aria-hidden="true"></i>
                </a>
            {% endif %}
            
            <a href="mailto:{{ item.mail }}" title="Email Delegación" style="color: inherit;">
